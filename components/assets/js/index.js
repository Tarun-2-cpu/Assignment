$(function() {
    ...
    toastr['info']('Hello, welcome to VistaChain, a unique admin Template.');
    ...
    var chart = c3.generate({    
        ...
        data: {
            ...
            colors: {
                'data1': VistaChain.colors["orange"],
                'data2': VistaChain.colors["green"],
                'data3': VistaChain.colors["gray-light"]
            },
            names: {
                // name of each serie
                'data1': 'Bitcoin',
